...
## v1.7.0b2 (beta)
- The firmware installation is now offered on the AC ELWA 2 as well; the first beta only recognised AC•THOR firmware versions and silently kept every ELWA report-only.
